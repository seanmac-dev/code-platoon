...
class BinaryTree:
    ...
    # def __str__(self):
    #     return f"val is {self.value}, left is {self.left}, right is {self.right}"
...
# Example of building tree manually
another_root = BinaryTree(
    value=5,  # value
    left=BinaryTree(  # left branch
        value=2,
        left=None,
        right=None,
    ),
    right=BinaryTree(  # right branch
        value=12,
        left=None,
        right=None,
    ),
...
# Example of manually building a binary tree with dictionaries
yet_another_root = {
    "val": 5,
    "left": {
        "val": 2,
